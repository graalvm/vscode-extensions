...
* The ahead-of-time compilation with GraalVM Native Image, to turn your Java application into small executables, perfect for storing in the cloud and microservices deployments
