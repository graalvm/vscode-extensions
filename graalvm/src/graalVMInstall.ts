...
async function changeGraalVMComponent(graalVMHome: string, components: GraalVMComponent[], action: string): Promise<void> {
...
async function getAvailableComponents(graalVMHome: string): Promise<GraalVMComponent[]> {
